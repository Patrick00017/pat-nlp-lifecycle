...
class SplicerLogStateMachine:
    ...
    def __init__(self):
        self.machine = Machine(model=self, states=SplicerLogStateMachine.states, initial='normal')

        # 定义状态转换
        self.machine.add_transition(trigger='change_paper', source='normal', dest='paperChange')
        self.machine.add_transition(trigger='change_paper_done', source='paperChange', dest='normal')
